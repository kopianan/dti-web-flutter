...
mixin _$QuestionnaireModel {
  ...
  String? get importantNotes => throw _privateConstructorUsedError;
  ResultModel? get results => throw _privateConstructorUsedError;
...
class _$_QuestionnaireModel implements _QuestionnaireModel {
  ...
  @override
  String toString() {
    return 'QuestionnaireModel(subQuestionnaire: $subQuestionnaire, footer: $footer, imgName: $imgName, body: $body, header: $header, description: $description, importantNotes: $importantNotes, results: $results)';
  }
