...
@RoutePage()
class PassportPaymentPage extends StatefulWidget {
  const PassportPaymentPage({super.key, required this.visa});
  final VisaApplicationModel visa;

  static const String routeName = '/passport-payment';
...
class _PassportPaymentPageState extends State<PassportPaymentPage>
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      create: (context) =>
          getIt<PaymentCubit>()..makePassportPayment(widget.visa),
