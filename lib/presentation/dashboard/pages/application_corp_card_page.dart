...
@RoutePage()
class ApplicationCorpCardPage extends StatefulWidget {
  static const String routeName = '/application-corp-card';
  const ApplicationCorpCardPage({super.key, required this.dashboardCubit});
  final DashboardCubit dashboardCubit;

  @override
  State<ApplicationCorpCardPage> createState() =>
      _ApplicationCorpCardPageState();
}
      ...
      body: SizedBox(
        ...
        child: BlocConsumer<AppListCubit, AppListState>(
          ...
          builder: (context, state) {
            ...
            } else if (state.status == AppListStatus.success) {
