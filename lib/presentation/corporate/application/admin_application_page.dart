...
class _AdminApplicationPageState extends State<AdminApplicationPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: BlocListener<AppListCubit, AppListState>(
        ...
        child: BlocBuilder<AppListCubit, AppListState>(
          bloc: getIt<AppListCubit>()..getUserApplication(isAgent: false),
    ...
    return DataRow2(
      ...
      cells: [
        ...
        DataCell(Text(DateConverter.convertDateDefault(
            visa.bodyData.usedByDate?.toIso8601String()))),
        DataCell(Text(visa.bodyData.title ?? "")),
