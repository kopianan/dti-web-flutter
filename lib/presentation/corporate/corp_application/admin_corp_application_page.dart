...
@RoutePage()
class AdminCorpApplicationPage extends StatefulWidget {
  const AdminCorpApplicationPage({super.key});

  @override
  State<AdminCorpApplicationPage> createState() =>
      _AdmiCorpnApplicationPageState();
}

class _AdmiCorpnApplicationPageState extends State<AdminCorpApplicationPage> {
  @override
  void initState() {
    context.read<AdminApplicationCubit>().getAllUserCorpVisa();
    super.initState();
  }
    ...
    return BlocListener<AdminApplicationCubit, AdminApplicationState>(
        listener: (context, state) {
          state.maybeMap(
            ...
            getAllUserCorpVisa: (e) {
              EasyLoading.dismiss();
              context.read<AdminDataCubit>().setApplicationCorpData(e.visas);
            },
            loading: (e) {
              EasyLoading.show();
            },
