...
import 'application/dashboard/cubit/dashboard_application_cubit.dart' as _i47;
import 'application/dashboard/cubit/dashboard_data_cubit.dart' as _i8;
import 'application/dashboard/dashboard_cubit.dart' as _i48;
import 'application/document/document_cubit.dart' as _i10;
import 'application/feedback/cubit/feedback_cubit.dart' as _i49;
import 'application/global/global_user_cubit.dart' as _i50;
...
import 'core/firebase_injectable_module.dart' as _i51;
...
_i1.GetIt $initGetIt(
  ...
  gh.singleton<_i8.DashboardDataCubit>(_i8.DashboardDataCubit());
  gh.lazySingleton<_i9.Dio>(() => firebaseInjectableModule.dio);
  gh.lazySingleton<_i10.DocumentCubit>(() => _i10.DocumentCubit());
  ...
  gh.lazySingleton<_i13.IAdminApplication>(
      () => _i14.AdminApplicationRepository(gh<_i9.Dio>()));
  gh.lazySingleton<_i15.IAgent>(() => _i16.AgentRepository(gh<_i9.Dio>()));
  gh.lazySingleton<_i17.IAppList>(() => _i18.AppListRepository(gh<_i9.Dio>()));
  ...
  gh.lazySingleton<_i21.IContactUs>(
      () => _i22.ContactUsRepository(gh<_i9.Dio>()));
  gh.lazySingleton<_i23.ICustomer>(
      () => _i24.CustomerRepository(gh<_i9.Dio>()));
  gh.lazySingleton<_i25.IDashboard>(() => _i26.DashboardRepository());
  gh.lazySingleton<_i27.IFeedback>(
      () => _i28.FeedbackRepository(gh<_i9.Dio>()));
  gh.lazySingleton<_i29.IOther>(() => _i30.OtherRepository(gh<_i9.Dio>()));
  gh.lazySingleton<_i31.IPayment>(() => _i32.PaymentRepository(gh<_i9.Dio>()));
  gh.lazySingleton<_i33.IUpdateApplication>(
      () => _i34.IUpdateApplicationRepository(gh<_i9.Dio>()));
  ...
  gh.lazySingleton<_i50.GlobalUserCubit>(
      () => _i50.GlobalUserCubit(gh<_i29.IOther>()));
  return getIt;
}
